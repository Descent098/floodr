...
<details>
  ...
  No, not explicitly. The amount of time a benchmark runs for is a product of all of the other parameters and is quite variable based on setup. There are plans in the future to add a mode for just running for a set amount of time
</details>
<details>
